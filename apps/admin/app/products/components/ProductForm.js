...
export default function ProductForm({ shops }) {
  ...
  return (
    <form onSubmit={handleSubmit} className="bg-white rounded-xl border border-gray-200 p-6 shadow-sm max-w-md space-y-5">
      <div>
      ...
      <button
        type="submit"
        className="w-full rounded-lg bg-black text-white text-sm font-medium py-2.5 hover:bg-gray-800 transition-colors"
      >
        Add Product
      </button>
    </form>
